...
describe('AuthController (e2e)', function () {
    var app;
    var authUrl = "http://localhost:3000/api/v1/auth";
    var mockUser = {
        firstName: 'John',
        lastName: 'Doe',
    ...
    describe('/auth/register (POST)', function () {
        it('should register a user and return the new user object', function () {
            return request(authUrl)
                .post('/register')
                .set('Accept', 'application/json')
                .send(mockUser)
                .expect(function (response) {
                var _a = response.body, id = _a.id, firstName = _a.firstName, lastName = _a.lastName, email = _a.email, password = _a.password, imagePath = _a.imagePath, role = _a.role;
