...
export class UserService {
    ...
    findUserByIdNotFeedPost(id: number): Observable<User> {
        return from(
    ...
    getFriendRequestStatus(
        ...
        return this.findUserByIdNotFeedPost(receiverId).pipe(
            switchMap((receiver: User) => {
                return from(
                    this.friendRequestRepository.findOne({
                        where: [
