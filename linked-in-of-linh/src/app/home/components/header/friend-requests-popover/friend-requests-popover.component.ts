...
import { FriendRequest } from 'src/app/home/services/models/FriendRequest';
            ...
            .pipe(
              ...
              tap((user: User) => {
                friendRequest['fullImagePath'] =
                  'http://localhost:3000/api/v1/feed/images/' +
                  (user?.imagePath || 'blank-profile-picture-973460__340.webp');
              })
            )
            .subscribe();
        }
